pipeline {
    agent any
	parameters {
	    string(name: 'tomcat_dev', defaultValue: '18.223.112.135', description: 'Staging Server')
	    string(name: 'tomcat_prod', defaultValue: '13.59.206.81', description: 'Production Server')
    }
